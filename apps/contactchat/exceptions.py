...
class ContactChatApiError(BaseError):
    """When ContactChat API response errors, this error will be raised."""
    ...
    def __init__(self, status_code, error=None):
        ...
        :type error: :py:class:`contactchat.models.error.Error`
        """
        super(ContactChatApiError, self).__init__(error.message)
