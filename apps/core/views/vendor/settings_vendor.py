...
def index(request):
    ...
    return render(request, "vendor/settings_vendor_index.html", context)
...
def contract_index(request, vendor_user_id=None):
    ...
    return render(request, "vendor/settings_contract_index.html", context)
...
def organization_list(request, vendor_user_id=None):
    ...
    return render(request, "vendor/settings_organization_list.html", context)
...
def account_list(request, vendor_user_id=None):
    ...
    return render(request, "vendor/settings_account_list.html", context)
...
def account_add(request):
    ...
    return render(request, "vendor/settings_vendor_new_account.html", context)
