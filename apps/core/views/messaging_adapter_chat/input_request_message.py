...
from apps.core.views.messaging_native_chat.contactchat.input_message import *


def input_request_message(end_user_info, param):
    if "fbms" in end_user_info["platform"]:
        ...
        contactchat_input_message(end_user_info, param)
