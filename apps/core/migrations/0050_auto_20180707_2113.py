# Generated by Django 2.0.5 on 2018-07-07 12:13
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0049_auto_20180703_1651'),
    ]

    operations = [
        migrations.CreateModel(
            name='WorkerSQSStatus',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('message_id', models.CharField(max_length=512, null=True, verbose_name='message_id')),
