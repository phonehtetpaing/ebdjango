...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0008_auto_20180603_1448'),
    ]

    operations = [
        migrations.CreateModel(
            name='EndUserAutoMessage',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('message_target_dt', models.DateTimeField(auto_now_add=True, null=True, verbose_name='target datetime')),
                ...
                ('auto_message_type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='enduserautomessage_auto_message_type', to='core.AutoMessageType', verbose_name='auto_message_type')),
                ('end_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='enduserautomessage_end_user', to='core.EndUser', verbose_name='end_user')),
            ],
            options={
