...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='is_todo',
            field=models.BooleanField(default=0, verbose_name='delete flg'),
        ),
        ...
        migrations.AlterField(
            ...
            name='cd',
            field=models.CharField(max_length=256, null=True, verbose_name='status code'),
        ),
    ]
