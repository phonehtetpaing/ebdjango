# Generated by Django 2.0.5 on 2018-06-13 09:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=128, null=True, verbose_name='Title for settings')),
        ...
        migrations.AddField(
            model_name='automessagetrigger',
            name='message_status',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='automessagetrigger_message_status', to='core.MessageStatus', verbose_name='message_status'),
        ),
    ]
