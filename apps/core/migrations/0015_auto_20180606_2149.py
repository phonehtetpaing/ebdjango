# Generated by Django 2.0.5 on 2018-06-06 12:49
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0014_auto_20180606_2147'),
    ]

    operations = [
        migrations.CreateModel(
            name='EndUserStoryHistory',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('is_todo', models.BooleanField(default=0, verbose_name='delete flg')),
                ...
                ('end_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='enduserstoryhistory_end_user', to='core.EndUser', verbose_name='end_user')),
                ('end_user_story', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='enduserstoryhistory_end_user_story', to='core.EndUserStory', verbose_name='end_user_story')),
                ('vendor_branch', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='enduserstoryhistory_vendor_branch', to='core.VendorBranch', verbose_name='vendor_branch')),
            ],
            options={
