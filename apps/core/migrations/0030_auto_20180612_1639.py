# Generated by Django 2.0.5 on 2018-06-12 07:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cd', models.CharField(max_length=256, null=True, verbose_name='tag code')),
                ('name', models.CharField(max_length=256, null=True, verbose_name='tag name')),
                ...
                ('tag_category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tag_tag_category', to='core.TagCategory', verbose_name='TagCategory')),
            ],
            options={
                'verbose_name': 'Tag',
                'permissions': (),
