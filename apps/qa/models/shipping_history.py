...
class ShippingHistory(models.Model):
    """ Shipping History """
    product = models.ForeignKey(Product, verbose_name='Product_Shipping_History', related_name='%(class)s_product_shipping_history', null=True,on_delete=models.CASCADE)
    business_partner = models.ForeignKey(VendorBusinessPartner, verbose_name='BP_Shipping_History', related_name='%(class)s_bp_shipping_history', null=True,on_delete=models.CASCADE)
